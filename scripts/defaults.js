...
Hooks.once('tokenActionHudCoreApiReady', async (coreModule) => {
    DEFAULTS = {
        ...
        groups: [
            ...
            {id: 'inventory_weapons', name: coreModule.api.Utils.i18n('TYPES.Item.weapon'), type: 'system'},
            {id: 'inventory_spells', name: coreModule.api.Utils.i18n('TYPES.Item.spellbook'), type: 'system'},
            {id: 'inventory_armors', name: coreModule.api.Utils.i18n('TYPES.Item.armor'), type: 'system'},
            {id: 'inventory_items', name: coreModule.api.Utils.i18n('TYPES.Item.item'), type: 'system'},
